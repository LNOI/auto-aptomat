...
class TuyaController:
    ...
    @staticmethod
    def _read_snapshot_sync(snapshot_path: str) -> Dict[str, Dict[str, Any]]:
        """Synchronous helper to read snapshot file"""
    ...
    async def read_snapshot_devices(snapshot_path: str = "snapshot.json") -> Dict[str, Dict[str, Any]]:
        ...
        try:
            ...
            return await asyncio.to_thread(TuyaController._read_snapshot_sync, snapshot_path)
    ...
    def _create_device_sync(
        ...
        """Synchronous helper to create device"""
    ...
    async def _create_device(
        ...
        try:
            # Run blocking device creation in thread pool
            return await asyncio.to_thread(
                TuyaController._create_device_sync,
                device_id,
                device_ip,
                device_key,
                device_version
    ...
    async def get_status(
        ...
        try:
            ...
            # Run blocking status call in thread pool
    ...
    async def turn_on(
        ...
        try:
            ...
            # Run blocking turn_on call in thread pool
            result = await asyncio.to_thread(device.turn_on)
    ...
    async def turn_off(
        ...
        try:
            ...
            # Run blocking turn_off call in thread pool
            result = await asyncio.to_thread(device.turn_off)
